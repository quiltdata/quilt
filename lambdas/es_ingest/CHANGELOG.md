...
- [Changed] Move this lambda to the shared uv workspace packaging flow; ingest behavior is otherwise unchanged ([#4933](https://github.com/quiltdata/quilt/pull/4933))
