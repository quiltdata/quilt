...
- [Added] Respect new `dest_prefix` parameter for setting prefix to copy data to while promoting packages with `copy_data: true` ([#4383](https://github.com/quiltdata/quilt/pull/4383))
