        ...
        if registry is None:
            ...
            if registry is None:
                raise QuiltException("No registry specified and no default remote "
                                     ...
                                     "or configure a default remote registry with quilt3.config")
        elif registry == 'local':
        ...
        if logical_key:
            ...
            if not first_pkey.endswith(first_lkey):
                raise QuiltException(
                    ...
                    f"consistent run 'quilt3.Package.install(\"$PKG_NAME\")', replacing '$PKG_NAME' "
            ...
            for lkey, entry in self.walk():
                ...
                if scheme != hypothesized_scheme:
                    raise QuiltException(
                        ...
                        f"consistent run 'quilt3.Package.install(\"$PKG_NAME\")', replacing "
                    ...
                    raise QuiltException(
                        ...
                        f"package physically consistent run 'quilt3.Package.install(\"$PKG_NAME\")', "
