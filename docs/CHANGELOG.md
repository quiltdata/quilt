...
* [Added] `quilt3.admin.RoleOwnsDataProductsError` — `admin.roles.delete()` raises it when the registry refuses to delete a role that owns data products, instead of the generic `Quilt3AdminError` ([#5299](https://github.com/quiltdata/quilt/pull/5299))
