...
* [Fixed] Bulletproof downloads via HTTP header override ([#1787](https://github.com/quiltdata/quilt/pull/1787))
* [Fixed] Fix previews not rendering in global search ([#1787](https://github.com/quiltdata/quilt/pull/1787))
