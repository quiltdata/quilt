...
* [Added] Add link to package revisions from package list ([#3247](https://github.com/quiltdata/quilt/pull/3247))
* [Changed] Make file preview wrapper consistently 100% width ([#3245](https://github.com/quiltdata/quilt/pull/3245))
* [Changed] Rename "Metadata" to "User metadata" and expand JSON to 100% width ([#3247](https://github.com/quiltdata/quilt/pull/3247))
