...
If an IAM intake form only lists "SAML" and "OAuth", pick **OAuth**;
if neither fits, pick **Other** and link to this section.

If a central IAM team will create the app registration for you, the steps
below double as the spec to hand them. You will need back from them:
**Application (client) ID**, **Directory (tenant) ID**, and the client
