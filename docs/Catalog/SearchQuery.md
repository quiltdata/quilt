...
It is also possible to set default workgroup in `ui > athena > defaultWorkgroup: 'you-default-workgroup'`.
([Learn more](./Preferences.md)).

Workgroup, catalog name and database selects memorize the last selected value.
