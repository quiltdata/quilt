...
## Export of non-columnar data
| Command line | Python | Description |
| --- | --- | --- |
| `quilt export USER/PACKAGE` |  `quilt.export("USER/PACKAGE")` | Export non-columnar file data to currend dir |
| `quilt export USER/PACKAGE DEST` |  `quilt.export("USER/PACKAGE", "DEST")` | Export non-columnar file data to specified destination |
