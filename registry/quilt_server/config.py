...
DISABLE_USER_ENDPOINTS = os.getenv('DISABLE_USER_ENDPOINTS', 1) # true by default
if DISABLE_USER_ENDPOINTS == 'False':
    DISABLE_USER_ENDPOINTS = False
else:
    DISABLE_USER_ENDPOINTS = True
