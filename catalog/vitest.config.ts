...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'app/containers/Bucket/Selection/Dashboard.spec.tsx',
      'app/components/FileEditor/CreateFile.spec.tsx',
      'app/containers/Bucket/Dir/Toolbar/Toolbar.spec.tsx',
      'app/containers/Bucket/CodeSamples.spec.tsx',
      'app/components/Filters/NumbersRange.spec.tsx',
      'app/containers/Bucket/Overview/Downloads.spec.ts',
      ...
      'app/components/FileEditor/loader.spec.ts',
