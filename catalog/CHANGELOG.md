...
- [Fixed] Page layouts follow the width of the content column rather than the viewport, so opening the Qurator panel no longer leaves the bucket header, package pages, listings and search in a wide-screen layout at a phone's width, and each of those tiers still changes at the width it did before ([#5332](https://github.com/quiltdata/quilt/pull/5332))
