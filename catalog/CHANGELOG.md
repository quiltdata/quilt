...
- [Fixed] Hover, strength-meter and preview animations no longer animate layout properties (margins, widths, max-height) — the collaborator-avatar spread and password-strength fill now move on the compositor, the code-options popover switches width without a janky resize animation, and both honor `prefers-reduced-motion` ([#5230](https://github.com/quiltdata/quilt/pull/5230))
