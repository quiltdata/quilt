...
- [Fixed] Bucket icons: an uploaded or URL icon no longer sits a few pixels below the initials disc in the admin bucket list and everywhere else the two share a row ([#PENDING](https://github.com/quiltdata/quilt/pull/PENDING))
