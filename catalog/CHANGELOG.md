...
- [Fixed] Admin status: the indexing panel drops its activity claim when a poll fails or hangs, reports a bad response instead of an empty queue, and announces state changes to screen readers ([#5322](https://github.com/quiltdata/quilt/pull/5322))
