...
- [Added] Packages list: a package's namespace is its own link, filtering the list to that namespace, and the sidebar lists each namespace with its package count ([#XXXX](https://github.com/quiltdata/quilt/pull/XXXX))
