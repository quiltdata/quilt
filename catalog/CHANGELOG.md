...
- [Added] Package revisions can be deleted in bulk: select revisions on the revision list and delete them together, or delete a whole package from the revision menu ([#TBD](https://github.com/quiltdata/quilt/pull/TBD))
