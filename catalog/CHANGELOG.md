...
- [Fixed] Admin users: sorting the table or editing one row no longer clears the rows an admin has selected for a bulk action ([#PR](https://github.com/quiltdata/quilt/pull/PR))
