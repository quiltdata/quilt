...
- [Fixed] Admin status: a hung request to the indexing endpoint now times out instead of leaving the panel animating over minutes-old data with no error ([#5320](https://github.com/quiltdata/quilt/pull/5320))
