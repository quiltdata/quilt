...
- [Fixed] On a small phone, file names are no longer truncated to a few characters, each row's bookmark and download actions stay on screen, and the directory toolbar wraps instead of widening the page ([#TBD](https://github.com/quiltdata/quilt/pull/TBD))
