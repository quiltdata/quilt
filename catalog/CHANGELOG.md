...
- [Fixed] Rendered-markdown table borders and the Qurator chat input's corner radius now use theme tokens (divider color, 4px radius) instead of hard-coded values ([#N](https://github.com/quiltdata/quilt/pull/N))
