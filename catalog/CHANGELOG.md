...
- [Fixed] Get popover: it no longer crashes when its Code tab disappears while selected, and its active-tab underline and panel switch honor `prefers-reduced-motion` ([#PR](https://github.com/quiltdata/quilt/pull/PR))
