...
- [Fixed] Bucket icons: a custom icon lines up with the initials disc beside it instead of sitting a few pixels low ([#PENDING](https://github.com/quiltdata/quilt/pull/PENDING))
