...
- [Fixed] Opening Qurator no longer blanks the whole catalog while the panel's first read is in flight, and a failure inside the panel shows a retry there instead of the app-level error screen ([#5338](https://github.com/quiltdata/quilt/pull/5338))
