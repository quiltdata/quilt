...
- [Fixed] Anonymous direct HTML previews render CORS-readable public objects stored with a non-HTML content type instead of appearing blank ([#5314](https://github.com/quiltdata/quilt/pull/5314))
