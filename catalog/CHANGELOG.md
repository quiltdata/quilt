...
- [Removed] Non-standard Pandoc / PHP-Markdown-Extra shortcut syntaxes: `==mark==`, `^sup^`, `~sub~`, `++ins++`, abbreviations (`*[HTML]: ...`), definition lists, and footnotes; raw inline HTML for these tags still renders ([#4884](https://github.com/quiltdata/quilt/pull/4884))
