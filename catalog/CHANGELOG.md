...
- [Fixed] Tabular preview: when a `quilt_summarize.json` perspective config names a column the file does not have, the preview now says it could not render the table instead of showing an empty panel with no explanation (PR-NUMBER)
