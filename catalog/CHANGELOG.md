...
- [Fixed] Quilt+ URI parsing retains the informational `catalog` field and shares its compatibility corpus with quilt3 ([#5255](https://github.com/quiltdata/quilt/pull/5255))
