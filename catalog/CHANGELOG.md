...
- [Added] Landing page: bucket icons on the bucket cards, falling back to a half-transparent white default for buckets without a custom `iconUrl` ([#4970](https://github.com/quiltdata/quilt/pull/4970))
