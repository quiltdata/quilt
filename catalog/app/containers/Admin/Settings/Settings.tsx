...
// There is no catalog-connection section any more. Data products are volumes this
// stack's own registry defines, so there is no external catalog to point at and
// nothing for an admin to connect. The `data-products` flag stays the gate for the
// product surfaces themselves; provisioning workspaces and connectors is the admin
// console's, and out of this stream (DEC-45).
