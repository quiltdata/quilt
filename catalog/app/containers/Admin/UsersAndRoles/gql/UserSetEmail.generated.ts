...
export type containers_Admin_UsersAndRoles_gql_UserSetEmailMutationVariables = Exact<{
  name: string
  email: string
}>

export interface containers_Admin_UsersAndRoles_gql_UserSetEmailMutation {
