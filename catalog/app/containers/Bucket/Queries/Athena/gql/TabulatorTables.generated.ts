...
export type containers_Bucket_Queries_Athena_gql_TabulatorTablesQueryVariables =
  Types.Exact<{
...
export const containers_Bucket_Queries_Athena_gql_TabulatorTablesDocument = {
  kind: 'Document',
  definitions: [
    {
      ...
      name: {
        kind: 'Name',
        value: 'containers_Bucket_Queries_Athena_gql_TabulatorTables',
      },
      variableDefinitions: [
        {
  ...
  containers_Bucket_Queries_Athena_gql_TabulatorTablesQuery,
  containers_Bucket_Queries_Athena_gql_TabulatorTablesQueryVariables
>

export { containers_Bucket_Queries_Athena_gql_TabulatorTablesDocument as default }
