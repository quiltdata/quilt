...
const P = (props) => <Typography color="textSecondary" {...props} />

const TeamMember = ({ name, head, children }) => (
  <Box display="flex" mt={6} mx="auto" maxWidth={800}>
    <Box
      component="img"
      borderRadius={19}
      src={head}
...
const Team = () => (
  <>
    ...
    <TeamMember name="Aneesh Karve, CTO" head={headAneeshKarve}>
      <P>
        <A href="https://www.linkedin.com/in/aneeshkarve">Aneesh</A> has shipped products
        to millions of users around the globe. He has worked as a{' '}
        <A href="http://www.visualmagnetic.com/">product manager and lead designer</A> at
        companies like Microsoft, NVIDIA, and Matterport. Aneesh was the general manager
        and founding member of AdJitsu, the first realtime 3D advertising platform for
        iOS,{' '}
    ...
    <TeamMember name="Dima Ryazanov, Sr. Software Engineer" head={headDimaRyazanov}>
      <P>
        ...
        where he also worked on user growth initiatives and optimized web performance. In
        his spare time Dima flies planes.
      </P>
    </TeamMember>
    <TeamMember name="Calvin Cochran, Software Engineer" head={headCalvinCochran}>
      <P>
        ...
        high-performance parsing framework for semi-structured strings, and helped design
        a high-throughput, persistent, distributed message transform system. In his free
        time Calvin plays Super Smash Bros. Melee.
      </P>
    </TeamMember>
  </>
)
...
const Advisors = () => (
  <>
    <Box mt={10} display="flex" flexDirection="column" alignItems="center">
      <Bar color="secondary" />
      <Box mt={5}>
        <Typography variant="h1">Advisors</Typography>
      </Box>
    </Box>
    <TeamMember name="Eli Collins" head={headEliCollins}>
      <P>
        ...
        Eli is an active advisor and investor in analytics startups, and holds Bachelor’s
        and Master’s degrees in Computer Science from New York University and the
    ...
    <TeamMember name="Ben Golub" head={headBenGolub}>
      <P>
        ...
        enterprise startups. Most recently, he was co-founder and CEO of Docker, which is
        known for sparking the containerization revolution and quickly amassing both a
        large community and a rapidly growing base of Global 2000 enterprise customers.
        Prior to Docker, he was CEO of Gluster, which was successfully acquired by Red Hat
        in 2011, and CEO of Plaxo, which was acquired by Comcast in 2008. Prior to Plaxo,
        he was EVP/GM of the Security, Payments, and Trust division of VeriSign. He
        currently serves on the boards of a number of for-profit and nonprofit boards. Ben
        holds an MBA/MPP from Harvard and a BA from Princeton.
      </P>
    </TeamMember>
    <TeamMember name="Ernie Prabhakar" head={headErniePrabhakar}>
      <P>
        ...
        17-year veteran of Apple Computer, where he drove adoption of UNIX and Open Source
        technologies across Apple’s operating systems and development platforms, starting
        with the launch of Mac OS X Server 1.0 in 1999 to support the original iMac. Since
        leaving Apple in 2014 he has worked with a range of hardware, SaaS and social
        impact startups as a Platform Designer, Product Manager, and Launch Manager.
      </P>
    </TeamMember>
    <TeamMember name="Pankaj Shah" head={headPankajShah}>
      <P>
        <A href="https://www.linkedin.com/in/pankajshah2/">Pankaj Shah</A> is an investor
        and advisor to dozens of startups and venture capital firms. He is an{' '}
      ...
      <P>
        ...
        <A href="http://www.onehopefoundation.org/">ONEHOPE Foundation</A>. Pankaj is also
        an advocate for Every Mother Counts, Virgin Unite and Witness. Previously, he
        proudly served on the Board of Directors for BRAC USA and{' '}
        ...
        extreme poverty in Africa and Asia through innovative, entrepreneurial development
        programs. BRAC is the largest non-profit social enterprise in the developing world
        and focuses on microfinance, health, education, and social justice. Girls, Inc.,
        is a national non-profit youth organization dedicated to inspiring all girls to be
    ...
    <TeamMember name="Dan Webster" head={headDanWebster}>
      <P>
        ...
        researcher by day and developer by night. He holds a Ph.D. in Cancer Biology from
        Stanford, and is currently a Damon Runyon Postdoctoral Fellow at the National
        Cancer Institute. Dan is the creator of{' '}
