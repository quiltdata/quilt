...
export const components_Preview_gql_RestoreObjectDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'components_Preview_gql_RestoreObject' },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'GlacierRestoreTier' },
            },
          },
        },
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'restoreObject' },
            arguments: [
              {
                kind: 'Argument',
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                {
                  ...
                  typeCondition: {
                    kind: 'NamedType',
                    name: { kind: 'Name', value: 'RestoreObjectSuccess' },
                  },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'alreadyRestored' } },
                    ],
                  },
                },
                {
  ...
  components_Preview_gql_RestoreObjectMutation,
  components_Preview_gql_RestoreObjectMutationVariables
>

export { components_Preview_gql_RestoreObjectDocument as default }
