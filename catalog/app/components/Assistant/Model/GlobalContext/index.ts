...
const READ_GUIDANCE = [
  ...
  `2. For interpretable content (images, PDFs, Office docs, prose) under ${THRESHOLD / 1024} KiB`,
  '   use catalog_preview — it returns thumbnail-resized images and native Document',
  '   blocks the model can read.',
