...
class ImportTest(QuiltTestCase):
    ...
    def test_team_nonteam_imports(self):
        # Naming conflict during merge -- this tests both team/nonteam in an 
        # identical manner, so I renamed it from test_team_imports.
        mydir = os.path.dirname(__file__)
